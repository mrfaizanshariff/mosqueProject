    ...
    <footer className="bg-accent/10 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4">New Features</h3>
            <ul className="space-y-2">
              <li><Link href="/quran" className="text-sm hover:text-primary transition-colors">Quran Reader</Link></li>
              <li><Link href="/quranPlayer" className="text-sm hover:text-primary transition-colors">Quran Player</Link></li>
              <li><Link href="/ramadan" className="text-sm hover:text-primary transition-colors">Ramadan Companion</Link></li>
